...
<tileset version="1.10" tiledversion="1.11.0" name="props_animated" tilewidth="16" tileheight="16" tilecount="88" columns="11">
 <image source="../../images/props_animated.png" width="176" height="128"/>
 <tile id="18">
  <animation>
